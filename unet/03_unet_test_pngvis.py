...
pretrain_dir = "/root/lbx/Task01_BrainTumor_comparison/unet"
...
sample = next(iter(val_org_loader))
print("Sample image dimensions:", sample["image"].shape)
if "label" in sample:
    print("Sample label dimensions:", sample["label"].shape)
...
mysave_dir = "/root/lbx/Task01_BrainTumor_comparison/unet/test_outputs"
dataset = "MSD"
with torch.no_grad():
